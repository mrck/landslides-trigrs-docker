...
RUN yum update -y;\
yum install -y gfortran gcc-gfortran gdb make wget gcc-c++ gsl gsl-devel;\
yum clean all;
...
RUN mkdir /trigrs;\
cd /trigrs/;\
wget https://code.usgs.gov/usgs/landslides-trigrs/uploads/8805b8c629849bf7592e6abde427f0d1/landslides-trigrs-2.1.0.tar.gz;\
tar -xzf ./landslides-trigrs-2.1.0.tar.gz;\
rm -f ./landslides-trigrs-2.1.0.tar.gz;\
cd landslides-trigrs-2.1.0/src/TRIGRS/;\
cp -n ../TopoIndex/* ./;\
make;\
mkdir /trigrs/landslides-trigrs-2.1.0/bin/;\
cp prg tpx trg ../../bin;
